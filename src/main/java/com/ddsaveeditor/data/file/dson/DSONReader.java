...
class DSONReader {
    ...
    public DSONReader(byte[] File, UnhashBehavior behavior) throws ParseException {
        ...
        }
        {
            ...
            for (int i = 0; i < meta2.entries.length; i++) {
                Meta2Block.Meta2BlockEntry meta2Entry = meta2.entries[i];
                ...
                if (meta2Entry.isObject()) {
                    ...
                    field.type = DsonTypes.FieldType.TYPE_OBJECT;
                ...
                if (fieldStack.isEmpty()) {
                    if (field.type != DsonTypes.FieldType.TYPE_OBJECT) {
                ...
                while (!fieldStack.isEmpty() && fieldStack.peek().type == DsonTypes.FieldType.TYPE_OBJECT
    ...
    private void writeField(StringBuilder sb, DsonField field, int indent, boolean debug) {
        ...
        } else if (field.type == DsonTypes.FieldType.TYPE_FILE) {
